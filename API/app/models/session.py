...
class Aula(Base):
    ...
    flashcards = relationship("Flashcard", back_populates="aula", cascade="all, delete-orphan")
    simulados = relationship("Simulado", back_populates="aula", cascade="all, delete-orphan")
